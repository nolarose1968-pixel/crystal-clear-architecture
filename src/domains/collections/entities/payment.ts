...
export class Payment extends DomainEntity {
  ...
  static create(request: PaymentRequest): Payment {
    ...
    const now = TimezoneUtils.createTimezoneAwareDate(
  ...
  markAsProcessing(): void {
    ...
    this.updatedAt = TimezoneUtils.createTimezoneAwareDate(
      TimezoneContext.PAYMENT_PROCESSING,
    );
  }
  ...
  requiresManualReview(): boolean {
    return (
      this.amount.greaterThan(Money.create(10000, this.currency.getCode())) ||
      this.riskScore > 50
    );
  }
}
