...
export class LKeyMapper {
   ...
   */
  private generateLKeyForCategory(
    category: keyof typeof L_KEY_MAPPING,
    number: number,
  ): string {
...
export class EntityMapper {
  ...
  public mapParty(params: {
    ...
    const lKey =
      this.mapper.getLKey(params.type) ||
      this.mapper.generateNextLKey("PARTIES");
  ...
  public mapCustomer(params: {
    ...
    const lKey =
      this.mapper.getLKey(params.type) ||
      this.mapper.generateNextLKey("CUSTOMERS");
  ...
  public mapTransaction(params: {
    ...
    const lKey =
      this.mapper.getLKey(params.type) ||
      this.mapper.generateNextLKey("TRANSACTIONS");
  ...
  public mapOrder(params: {
    ...
    const lKey =
      this.mapper.getLKey(params.type) ||
      this.mapper.generateNextLKey("ORDERS");
    const statusLKey =
      this.mapper.getLKey(params.status) ||
      this.mapper.generateNextLKey("STATUS");
