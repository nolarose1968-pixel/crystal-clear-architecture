...
class WaterSystemCLI {
    ...
    createBox(title, content) {
        ...
        box.push(
            this.colors.cyan + '╭' + 
            '─'.repeat(leftPad) + 
            this.colors.bright + this.colors.blue + titleStr + 
            this.colors.reset + this.colors.cyan + 
            '─'.repeat(rightPad) + 
            '╮' + this.colors.reset
        );
    ...
    startMonitoring(intervalMs = 5000) {
        console.log(`${this.colors.cyan}🌊 Starting water system monitoring...${this.colors.reset}`);
        console.log(`${this.colors.cyan}Press Ctrl+C to stop${this.colors.reset}\n`);
