...
const FILE_CATEGORIES = {
  // HTML Files
  'water-dashboard-enhanced.html': { icon: '🌊', name: 'Water Dashboard', type: 'Enhanced Edition' },
    ...
    const updatedContent = content.replace(
      ...
      (match, title) => {
        ...
        const cleanTitle = title
          ...
          .replace(/\s*-\s*(Enhanced Edition|Core Edition|Complete System|Build Review|CLI Interface|Analytics|Main Hub|Manager Dashboard)\s*/g, '') // Remove existing types
    ...
    const updatedContent = content.replace(
      ...
      (match, title) => {
        ...
        const cleanTitle = title
          ...
          .replace(/Fire22\s*/, '') // Remove Fire22 prefix  
          .replace(/Dashboard\s*-\s*/, '') // Remove "Dashboard - " patterns
          .replace(/\s*-\s*(Enhanced Edition|Core Edition|Complete System|Build Review|CLI Interface|Analytics|Main Hub|Database Optimization Guide|Authentication API|Database Schemas)\s*/g, '') // Remove existing types
