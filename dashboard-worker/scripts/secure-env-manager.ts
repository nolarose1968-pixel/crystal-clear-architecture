...
class SecureEnvironmentManager {
   ...
   */
  private async promptForSensitiveValue(config: EnvironmentConfig, env: string, keyName: string): Promise<void> {
    ...
    switch (config.name) {
      ...
      case "CLOUDFLARE_API_TOKEN":
        ...
        break;
      case "JWT_SECRET":
        demoValue = Math.random().toString(36).substring(2) + Math.random().toString(36).substring(2);
        break;
      default:
