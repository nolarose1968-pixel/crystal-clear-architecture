...
const departmentLinks = {
    'finance-department.html': {
        links: [
            { title: '💸 Transaction Dashboard', url: '../dashboard.html#transactions', description: 'Real-time transaction monitoring' },
            { title: '📊 Financial Reports', url: '../reports/financial.html', description: 'Comprehensive financial analytics' },
            { title: '🏦 Banking Portal', url: '../banking/', description: 'Secure banking operations' },
            { title: '💰 Revenue Analytics', url: '../analytics/revenue.html', description: 'Revenue tracking and projections' },
            { title: '📈 Budget Management', url: '../budget/', description: 'Budget planning and allocation' },
    ...
    'customer-support-department.html': {
        links: [
            ...
            { title: '📞 Call Center Dashboard', url: '../call-center/', description: 'Phone support metrics' },
            { title: '📚 Knowledge Base', url: '../kb/', description: 'Self-service documentation' },
            { title: '😊 Satisfaction Metrics', url: '../metrics/satisfaction.html', description: 'Customer satisfaction tracking' },
            { title: '🔄 Escalation Manager', url: '../escalations/', description: 'Priority issue handling' }
        ]
    },
    'compliance-department.html': {
        links: [
            { title: '📋 Compliance Dashboard', url: '../compliance-dashboard/', description: 'Regulatory compliance overview' },
            ...
            { title: '📝 License Tracker', url: '../licenses/', description: 'License compliance monitoring' }
        ]
    },
    'operations-department.html': {
        links: [
            { title: '⚡ Operations Center', url: '../ops-center/', description: 'Central operations dashboard' },
            { title: '📊 Performance Metrics', url: '../metrics/operations.html', description: 'Operational KPIs' },
            { title: '🔄 Process Automation', url: '../automation/', description: 'Automated workflow systems' },
            { title: '📦 Inventory Management', url: '../inventory/', description: 'Resource tracking system' },
            { title: '👥 Staff Scheduling', url: '../scheduling/', description: 'Team scheduling portal' },
            { title: '📈 Capacity Planning', url: '../capacity/', description: 'Resource capacity analysis' }
        ]
    },
    'technology-department.html': {
        links: [
            { title: '🚀 Fire22 Dashboard', url: '../dashboard.html', description: 'Main platform dashboard' },
            { title: '🔗 API Documentation', url: '../api-docs/', description: 'REST API reference' },
            { title: '💻 System Monitoring', url: '../monitoring/', description: 'Infrastructure monitoring' },
            { title: '🔐 Security Center', url: '../security/', description: 'Security operations center' },
            { title: '📊 Performance Analytics', url: '../analytics/performance.html', description: 'System performance metrics' },
            { title: '🛠️ DevOps Portal', url: '../devops/', description: 'CI/CD and deployment tools' }
        ]
    },
    'marketing-department.html': {
        links: [
            { title: '📢 Campaign Manager', url: '../campaigns/', description: 'Marketing campaign control' },
            { title: '📊 Analytics Dashboard', url: '../analytics/marketing.html', description: 'Marketing performance metrics' },
    ...
    'management-department.html': {
        links: [
            { title: '👔 Executive Dashboard', url: '../executive/', description: 'C-suite overview panel' },
            { title: '📊 Company Metrics', url: '../metrics/company.html', description: 'Organization-wide KPIs' },
            { title: '🎯 Strategic Planning', url: '../strategy/', description: 'Strategic initiatives tracker' },
            { title: '💼 Board Portal', url: '../board/', description: 'Board member resources' },
            { title: '📈 Investor Relations', url: '../investors/', description: 'Investor information hub' },
            { title: '🏆 Goals & OKRs', url: '../okrs/', description: 'Objective tracking system' }
        ]
    },
    'team-contributors-department.html': {
        links: [
            { title: '🌟 Fire22 Showcase', url: '../../packages/@fire22/grid-ui/fire22-highlight-system-showcase.html', description: 'CSS highlight system showcase' },
            { title: '👥 Team Directory', url: '../team/', description: 'Complete team member directory' },
            { title: '🏆 Recognition Wall', url: '../recognition/', description: 'Employee achievements' },
            { title: '📚 Training Portal', url: '../training/', description: 'Professional development resources' },
            { title: '🎯 Performance Reviews', url: '../reviews/', description: 'Performance management system' },
            { title: '💡 Innovation Hub', url: '../innovation/', description: 'Ideas and suggestions portal' }
        ]
    }
};
