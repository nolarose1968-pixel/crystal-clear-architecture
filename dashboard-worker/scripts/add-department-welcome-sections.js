...
const departments = [
  {
    ...
    color: "#3b82f6",
    teamLead: { name: "Jessica Martinez", role: "Head of Customer Support", experience: "10+ years" },
    mission: "The Customer Support Department delivers exceptional service experiences, ensuring customer satisfaction and loyalty through responsive, empathetic, and solution-oriented support across all channels.",
    ...
    responsibilities: ["Customer Support", "Ticket Management", "Knowledge Base", "Live Chat", "Phone Support", "Escalation Handling"],
    contributions: [
  ...
  },
  {
    ...
    mission: "The Finance Department ensures fiscal responsibility and strategic financial management, driving profitability through accurate reporting, budget optimization, and data-driven financial decision-making.",
    ...
    responsibilities: ["Financial Planning", "Accounting", "Budget Management", "Financial Reporting", "Tax Compliance", "Investment Analysis"],
    contributions: [
  ...
  },
  {
    ...
    mission: "The Management Department provides strategic leadership and operational excellence, aligning organizational resources with business objectives to drive growth, innovation, and sustainable success.",
    ...
    responsibilities: ["Strategic Planning", "Operations Management", "Team Leadership", "Process Optimization", "Performance Management", "Change Management"],
    contributions: [
  ...
  },
  {
    ...
    mission: "The Marketing Department drives brand growth and customer engagement through innovative campaigns, data-driven strategies, and compelling storytelling that resonates with our target audiences.",
    metrics: { leadGen: "+127%", ROI: "4.2x" },
    rankings: [
      { position: "🥇", name: "S. Johnson", implementations: 62 },
      { position: "🥈", name: "A. Brown", implementations: 47 }
    ],
    responsibilities: ["Brand Strategy", "Digital Marketing", "Content Creation", "Campaign Management", "Market Research", "Social Media"],
    contributions: [
  ...
  },
  {
    ...
    mission: "The Operations Department ensures seamless business operations through process excellence, resource optimization, and continuous improvement initiatives that enhance productivity and service delivery.",
    metrics: { uptime: "99.95%", efficiency: "92%" },
    rankings: [
      { position: "🥇", name: "J. Wilson", implementations: 71 },
      { position: "🥈", name: "M. Davis", implementations: 58 }
    ],
    responsibilities: ["Process Management", "Quality Assurance", "Supply Chain", "Logistics", "Vendor Management", "Facilities"],
    contributions: [
  ...
  },
  {
    ...
    mission: "The Team Contributors Department fosters cross-functional collaboration and innovation, bringing together diverse talents to drive special projects, initiatives, and breakthrough solutions.",
    ...
    responsibilities: ["Innovation Projects", "Cross-team Collaboration", "Special Initiatives", "Knowledge Sharing", "Research & Development", "Process Innovation"],
    contributions: [
  ...
  },
  {
    ...
    mission: "The Technology Department drives digital innovation and infrastructure excellence, delivering cutting-edge solutions that power our platform, enhance security, and enable business growth through technology.",
    metrics: { uptime: "99.99%", deployments: "1,200+" },
    rankings: [
      { position: "🥇", name: "C. Brown", implementations: 89 },
      { position: "🥈", name: "A. Garcia", implementations: 76 }
    ],
    responsibilities: ["Software Development", "Infrastructure", "Security", "DevOps", "Data Architecture", "Technical Support"],
    contributions: [
            ...
            <div style="margin-top: 25px; padding: 20px; background: rgba(0, 0, 0, 0.2); border-radius: 12px;">
                ...
                <div style="background: rgba(0, 0, 0, 0.3); padding: 15px; border-radius: 8px;">
                    <ul style="list-style: none; padding: 0; margin: 0;">
                        ${dept.contributions.map((contrib, idx) => `
