...
export class Fire22SecurityScanner {
  ...
  private generateRecommendations(vulnerabilities: Vulnerability[]): string[] {
    ...
    recommendations.add("🔐 Use Bun.secrets for credential storage instead of environment variables");
  ...
  async performSecurityScan(directory: string = process.cwd()): Promise<SecurityScanResult> {
    ...
    console.log(`📊 Security Score: ${result.score}/100 (Risk Level: ${result.riskLevel.toUpperCase()})`);
