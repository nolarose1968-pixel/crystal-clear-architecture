...
export class Fire22Logger {
   ...
   */
  public log(level: LogLevel, message: string, context: LogContext = {}, metadata?: Record<string, any>): void {
  ...
  private updateMetrics(entry: LogEntry): void {
    ...
    const errorLogs = this.metrics.logsByLevel[LogLevel.ERROR] + this.metrics.logsByLevel[LogLevel.CRITICAL];
