...
export const createFantasy42NotificationToggle = (
	...
	return new Fantasy42NotificationToggle(fantasyClient, unifiedIntegration, wagerAlertSettings, config);
};
...
export const initializeFantasy42NotificationToggle = async (
	...
	const notificationToggle = new Fantasy42NotificationToggle(fantasyClient, unifiedIntegration, wagerAlertSettings, config);
