 ...
 */
export declare function rateLimiter(options?: RateLimitOptions): (request: AuthenticatedRequest) => Promise<Response | void>;
/**
 ...
 */
export declare function getRateLimitStatus(key: string, store?: RateLimitStore): Promise<RateLimitInfo | null>;
/**
 ...
 */
export declare function addRateLimitHeaders(response: Response, request: AuthenticatedRequest): Response;
