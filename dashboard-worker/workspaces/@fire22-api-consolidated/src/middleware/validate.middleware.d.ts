 ...
 */
export declare function validateBody<T extends z.ZodType>(schema: T): (request: ValidatedRequest) => Promise<Response | void>;
/**
 * Validation middleware for query parameters
 */
export declare function validateQuery<T extends z.ZodType>(schema: T): (request: ValidatedRequest) => Promise<Response | void>;
/**
 * Validation middleware for URL parameters
 */
export declare function validateParams<T extends z.ZodType>(schema: T): (request: ValidatedRequest) => Promise<Response | void>;
/**
 * Combined validation middleware (backwards compatibility)
 */
export declare function validate<T extends z.ZodType>(schema: T): (request: ValidatedRequest) => Promise<Response | void>;
/**
 ...
 */
export declare function createFire22Schema<T extends z.ZodRawShape>(shape: T): z.ZodObject<T, "strip", z.ZodTypeAny, z.objectUtil.addQuestionMarks<z.baseObjectOutputType<T>, any> extends infer T_1 ? { [k in keyof T_1]: T_1[k]; } : never, z.baseObjectInputType<T> extends infer T_2 ? { [k_1 in keyof T_2]: T_2[k_1]; } : never>;
/**
