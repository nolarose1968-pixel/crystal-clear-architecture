 ...
 */
export async function getWeeklyFigureByAgent(request) {
  try {
 ...
 */
export async function getPending(request) {
  try {
    const { agentID } = request.validatedBody || (await request.json());
 ...
 * Get live activity
 */
export async function getLiveActivity(request) {
  try {
 ...
 * Get live wagers
 */
export async function getLiveWagers(request) {
  try {
    const url = new URL(request.url);
    const agentID = url.searchParams.get('agentID');
    // Use validated Fire22 client
 ...
 */
export async function getAgentPerformance(request) {
  try {
    const url = new URL(request.url);
    const agentID = url.searchParams.get('agentID');
 ...
 * Get wager alerts
 */
export async function getWagerAlerts(request) {
  try {
 ...
 * Get VIP customers
 */
export async function getVIPCustomers(request) {
  try {
 ...
 * Get bet ticker
 */
export async function getBetTicker(request) {
  try {
 ...
 */
export async function getSportAnalytics(request) {
  try {
 ...
 */
export async function getCustomerDetails(request) {
  try {
    const url = new URL(request.url);
 ...
 * Get agent KPI
 */
export async function getAgentKPI(request) {
  try {
    const url = new URL(request.url);
    const agentID = url.searchParams.get('agentID');
    // Use validated Fire22 client
 ...
 */
export async function getCustomersByAgent(request) {
  try {
    const url = new URL(request.url);
    const agentID = url.searchParams.get('agentID');
    // Use validated Fire22 client
