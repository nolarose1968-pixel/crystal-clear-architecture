 ...
 * Settle wager
 */
export async function settleWager(request) {
  try {
 ...
 * Bulk settle wagers
 */
export async function bulkSettle(request) {
  try {
 ...
 */
export async function pendingSettlements(request) {
  try {
 ...
 * Void wager
 */
export async function voidWager(request) {
  try {
 ...
 */
export async function agentConfigsDashboard(request) {
  try {
 ...
 * Import customers
 */
export async function importCustomers(request) {
  try {
 ...
 * Sync Fire22 data
 */
export async function syncFire22(request) {
  try {
 ...
 */
export async function debugCacheStats(request) {
  try {
