 ...
 */
export async function testFire22(request) {
    try {
 ...
 */
export async function testDatabase(request) {
    try {
 ...
 * Readiness check
 */
export async function ready(request) {
    try {
 ...
 * Metrics endpoint
 */
export async function metrics(request) {
    try {
