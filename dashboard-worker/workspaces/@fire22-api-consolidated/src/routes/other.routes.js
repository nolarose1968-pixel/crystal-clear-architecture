...
router.get('//api/reports/settlement-history', authorize(["authenticated"]), controller.apiReportsSettlementHistory);
// /api/customers/telegram (from index.ts:3343)
router.put('//api/customers/telegram', authorize(["authenticated"]), controller.apiCustomersTelegram);
...
router.get('//api/reports/profit-loss', authorize(["authenticated"]), controller.apiReportsProfitLoss);
// /api/reports/customer-activity (from index.ts:4721)
router.get('//api/reports/customer-activity', authorize(["authenticated"]), controller.apiReportsCustomerActivity);
// /api/live-casino/dashboard-data (from index.ts:5212)
router.get('//api/live-casino/dashboard-data', authorize(["authenticated"]), controller.apiLiveCasinoDashboardData);
...
router.get('//api/fire22/agent-performance', authorize(["authenticated"]), controller.apiFire22AgentPerformance);
...
router.get('//api/customer-config/list', authorize(["authenticated"]), controller.apiCustomerConfigList);
// /api/customer-config/update (from index.ts:5942)
router.put('//api/customer-config/update', authorize(["authenticated"]), controller.apiCustomerConfigUpdate);
...
router.get('//api/debug/permissions-matrix', authorize(["authenticated"]), controller.apiDebugPermissionsMatrix);
// /api/debug/permissions-matrix/validation (from index.ts:6670)
router.get('//api/debug/permissions-matrix/validation', authorize(["authenticated"]), controller.apiDebugPermissionsMatrixValidation);
// /api/debug/permissions-matrix/agents (from index.ts:6746)
router.get('//api/debug/permissions-matrix/agents', authorize(["authenticated"]), controller.apiDebugPermissionsMatrixAgents);
// /api/debug/permissions-matrix/performance (from index.ts:6819)
router.get('//api/debug/permissions-matrix/performance', authorize(["authenticated"]), controller.apiDebugPermissionsMatrixPerformance);
// /api/debug/permissions-matrix/realtime (from index.ts:6877)
router.get('//api/debug/permissions-matrix/realtime', authorize(["authenticated"]), controller.apiDebugPermissionsMatrixRealtime);
...
router.post('//api/version/increment', authorize(["authenticated"]), controller.apiVersionIncrement);
...
router.get('//api/version/deployment', authorize(["authenticated"]), controller.apiVersionDeployment);
...
router.post('//api/sync/fire22-customers', authorize(["authenticated"]), controller.apiSyncFire22Customers);
