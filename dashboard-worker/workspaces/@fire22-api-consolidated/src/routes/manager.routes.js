...
router.post('/getWeeklyFigureByAgent', authorize(["manager.reports.weekly"]), controller.getWeeklyFigureByAgent);
...
router.get('/getAgentPerformance', authorize(["manager.agent.performance"]), controller.getAgentPerformance);
...
router.get('/getCustomersByAgent', authorize(["manager.customer.list"]), controller.getCustomersByAgent);
...
router.get('/getWeeklyFigureByAgent', authorize(["manager.reports.weekly"]), controller.getWeeklyFigureByAgent);
...
router.post('/getAgentPerformance', authorize(["manager.agent.performance"]), controller.getAgentPerformance);
