...
export type KYCStatus = 'pending' | 'in_review' | 'approved' | 'rejected' | 'expired' | 'not_required';
...
export type TransactionType = 'deposit' | 'withdrawal' | 'bet_placement' | 'bet_settlement' | 'adjustment' | 
                              'bonus' | 'freeplay' | 'commission' | 'transfer' | 'refund' | 'void';
export type TransactionStatus = 'pending' | 'processing' | 'completed' | 'failed' | 'cancelled' | 'voided';
export type PaymentMethod = 'credit_card' | 'bank_transfer' | 'crypto' | 'ewallet' | 'check' | 'cash';
...
export type SportType = 'football' | 'basketball' | 'baseball' | 'hockey' | 'soccer' | 'tennis' | 'golf' | 
                        'boxing' | 'mma' | 'horse_racing' | 'auto_racing' | 'esports' | 'other';
...
export type BonusType = 'welcome' | 'deposit_match' | 'free_play' | 'cashback' | 'loyalty' | 'promotional';
...
export type Fire22Entity = Fire22Customer | Fire22Agent | Fire22Transaction | Fire22Bet | 
                          Fire22Bonus | Fire22Game | Fire22Odds | Fire22Session | 
                          Fire22AuditLog | Fire22CustomerMetrics;

export type Fire22EntityType = 'customer' | 'agent' | 'transaction' | 'bet' | 'bonus' | 
                               'game' | 'odds' | 'session' | 'audit_log' | 'customer_metrics';
