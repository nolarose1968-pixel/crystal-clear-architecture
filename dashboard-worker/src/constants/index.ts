...
export const ERROR_MESSAGES = {
  DATABASE: {
    CONNECTION_FAILED: { code: 'E2001', message: 'Database connection failed', docs: '/docs/database/setup' },
    QUERY_TIMEOUT: { code: 'E2002', message: 'Database query timeout', docs: '/docs/database/optimization' },
    INVALID_SCHEMA: { code: 'E2003', message: 'Invalid database schema', docs: '/docs/database/schema' },
    DUPLICATE_ENTRY: { code: 'E2004', message: 'Duplicate entry found', docs: '/docs/database/constraints' },
    FOREIGN_KEY_CONSTRAINT: { code: 'E2005', message: 'Foreign key constraint violation', docs: '/docs/database/relationships' }
  },
  ...
  BUSINESS: {
    INSUFFICIENT_BALANCE: { code: 'E5001', message: 'Insufficient account balance', docs: '/docs/business/balance-management' },
    BETTING_LIMIT_EXCEEDED: { code: 'E5002', message: 'Betting limit exceeded', docs: '/docs/business/betting-limits' },
    INVALID_ODDS: { code: 'E5003', message: 'Invalid odds value', docs: '/docs/business/odds-validation' },
    EVENT_NOT_AVAILABLE: { code: 'E5004', message: 'Event not available for betting', docs: '/docs/business/event-management' },
    CUSTOMER_SUSPENDED: { code: 'E5005', message: 'Customer account suspended', docs: '/docs/business/account-management' }
  },

  SYSTEM: {
    INIT_FAILED: { code: 'E1001', message: 'System initialization failed', docs: '/docs/system/troubleshooting' },
    MEMORY_EXCEEDED: { code: 'E1002', message: 'Memory limit exceeded', docs: '/docs/system/memory' },
    CONFIG_INVALID: { code: 'E1003', message: 'Invalid configuration', docs: '/docs/system/config' }
  },

  NETWORK: {
    TIMEOUT: { code: 'E4001', message: 'Network request timeout', docs: '/docs/network/configuration' },
  ...
  SECURITY: {
    MULTIPLE_LOGIN_FAILURES: { code: 'E6001', message: 'Multiple failed login attempts detected', docs: '/docs/security/policies' },
    SUSPICIOUS_CONNECTION: { code: 'E6002', message: 'Suspicious connection detected', docs: '/docs/security/connection-monitoring' },
    UNAUTHORIZED_ACCESS: { code: 'E6003', message: 'Unauthorized access attempt', docs: '/docs/security/access-control' }
  },

  FIRE22: {
    API_CONNECTION_FAILED: { code: 'E7001', message: 'Fire22 API connection failed', docs: '/docs/integrations/fire22' },
    AUTH_FAILED: { code: 'E7002', message: 'Fire22 authentication failed', docs: '/docs/integrations/fire22-auth' },
    DATA_SYNC_FAILED: { code: 'E7003', message: 'Fire22 data sync failed', docs: '/docs/integrations/fire22-sync' }
  },

  TELEGRAM: {
    BOT_AUTH_FAILED: { code: 'E8001', message: 'Telegram bot authentication failed', docs: '/docs/integrations/telegram' },
    MESSAGE_SEND_FAILED: { code: 'E8002', message: 'Telegram message send failed', docs: '/docs/integrations/telegram-setup' },
    WEBHOOK_FAILED: { code: 'E8003', message: 'Telegram webhook failed', docs: '/docs/integrations/telegram-webhooks' }
  }
} as const;
...
export type TransactionType = typeof DATABASE.TRANSACTION_TYPES[keyof typeof DATABASE.TRANSACTION_TYPES];
