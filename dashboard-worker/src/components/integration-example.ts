...
export class DashboardKPIManager {
    ...
    public initializeDefaultKPIs(): void {
        ...
        this.kpis.set('pendingAmount', new KPIComponent({
        ...
        this.kpis.set('totalAgents', new KPIComponent({
            label: 'Total Agents',
            value: 0,
            format: 'number',
            color: 'primary',
        ...
        this.kpis.set('activeAgents', new KPIComponent({
            label: 'Active Agents',
            value: 0,
            format: 'number',
            color: 'success',
        ...
        this.kpis.set('pendingWagers', new KPIComponent({
