      ...
      case 'invalid-jsx-name':
        return (
          <div>
            ...
            <ul>
              <li><code>&lt;5minutes&gt;</code> → <code>&lt;FiveMinutes&gt;</code></li>
              <li><code>&lt;1password&gt;</code> → <code>&lt;OnePassword&gt;</code></li>
              <li><code>&lt;2factor&gt;</code> → <code>&lt;TwoFactor&gt;</code></li>
            </ul>
          </div>
        );
...
\`\`\``}</pre>
      ...
      case 'invalid-expression':
        return (
          <div>
            ...
            <ul>
              <li><code>{'{'} invalid syntax {'}'}</code> → <code>{'{'} validSyntax {'}'}</code></li>
  ...
  return (
    <div className="mdx-error-fallback" style={{
      padding: '2rem',
      margin: '1rem',
      ...
      <div className="api-endpoint">
        <strong>File:</strong> <code>{filePath || 'Unknown'}</code><br/>
      ...
      <div className="bun-highlight">
        <strong>🥖 Bun Development Note:</strong> MDX combines Markdown with JSX, 
        so all JSX syntax must be valid. Use the Bun development tools to validate 
        your markdown before deployment.
      </div>
      ...
      <div style={{ 
        ...
        <strong>💡 Alternative:</strong> If this content is not critical, you can temporarily 
        rename the file to <code>.txt</code> to exclude it from compilation while you fix the syntax.
      </div>
    </div>
  );
}