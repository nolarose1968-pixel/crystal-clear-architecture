    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="documentation-error">
          ...
          <p>
            This documentation page failed to load due to a compilation error.
            This is likely caused by invalid MDX syntax in the source file.
          </p>
          ...
          <div className="bun-highlight">
            <strong>🥖 Bun Development Tip:</strong> MDX requires valid JSX syntax. 
            Check for invalid component names (starting with numbers) or malformed expressions.
          </div>

          <h3>Common Solutions:</h3>
          <ul>
            <li>Remove or escape JSX-like syntax: <code>&lt;component5&gt;</code> → <code>&lt;Component5&gt;</code></li>
            <li>Wrap JavaScript expressions properly: <code>{'{ validExpression }'}</code></li>
