...
export class WagerEntity extends AuditableEntityClass implements Wager {
  ...
  public sport: 'football' | 'basketball' | 'baseball' | 'hockey' | 'soccer' | 'tennis' | 'golf' | 'mma' | 'boxing' | 'other';
  public league: string;
  public teams: string;
  public event_datetime: string;
  
  // Bet specifics
  public bet_type: 'spread' | 'moneyline' | 'total' | 'prop' | 'parlay' | 'teaser' | 'future' | 'live';
