 ...
 *
 * This index file now consolidates schemas from multiple modules
 * while maintaining backward compatibility.
 *
 * NEW MODULES AVAILABLE:
 * - ./auth - Authentication and user management schemas
 * - ./financial - Payment and transaction schemas
 * - ./common - Shared utility schemas (already imported above)
 *
 * FUTURE MODULES TO BE ADDED:
 * - ./customers - Customer management schemas
 * - ./wagers - Wagering and betting schemas
 * - ./agents - Agent management schemas
 * - ./rules - Business rules and validation schemas
 */
