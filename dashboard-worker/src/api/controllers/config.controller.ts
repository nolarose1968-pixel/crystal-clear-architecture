...
import { DynamicConfigManager, ConfigurableFeeService, DynamicFeeConfig } from '../../config/dynamic-config';
...
export class ConfigController {
  ...
  public getSystemConfigs = async (req: Request, res: Response) => {
    try {
      ...
      const configs = Array.from((this.configManager as any).systemConfigs.values())
        .filter(config => {
