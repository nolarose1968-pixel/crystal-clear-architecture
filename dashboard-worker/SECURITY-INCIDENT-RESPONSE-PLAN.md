...
### **Security References**
- **Error Code Index**: [E6001 - Security Violation](/scripts/error-code-index.ts:273-292)
- **Rate Limiting**: [E3002 - API Rate Limit](/scripts/error-code-index.ts:186-205)
- **Database Connection**: [E2001 - DB Connection Failed](/scripts/error-code-index.ts:122-141)
