# Language Localization Codes (LANGcode)

## Overview

This document contains language localization codes and their corresponding translations across multiple languages. The system supports the following languages:
...
Each language code follows the format `L-XXX` where XXX is a sequential number. Each code contains translations for all supported languages.

## Language Codes

### L-00 to L-99: Core Interface Elements

| Code | English | Spanish | Chinese | French | Greek | Korean | Vietnamese |
|------|---------|---------|---------|---------|-------|---------|------------|
| L-00 | Current Balance | Balance Actual | 现时帐目 | Solde Actuel | | 잔고 | Số(Tien)khoang hiện tại |
| L-01 | Total Pending | Total Pendiente | 未完场的帐目 | Solde en attente | | 대기중인 금액 | Tổng số (Tien) đang chờ xử lý |
| L-02 | Free Play | Jugada Gratis | 免费赌注 | Jeu Gratuit | | 무료 플레이 | Chơi miển phí |
| L-03 | Current Available | Actual Disponible | 余额 | Disponible Actuellement | | 현재 가능한 금액 | Hiện tại so khoang dang có |
| L-04 | Messages | Mensajes | 消息 | Messages | | 메세지 | |
| L-05 | Theme | Tema | 主题 | Thème | | 테마 | |
| L-06 | Sign Out | Salir | 退出 | Déconnexion | | | |
| L-07 | Sportsbook | Apuestas Deportivas | 体育博彩 | Sportsbook | | | |
| L-08 | Live Betting | En Vivo | 走地 | En Direct | | 라이브 배팅 | Cá cược trực tiep |
| L-09 | Live Casino | Casino en vivo | 现场赌场 | Casino En Direct | | | |
| L-10 | Casino | Casino | 赌场 | Casino Normal | | | |
| L-11 | Horses | Caballos | 赛马 | Chevaux | | 경마 | |
| L-12 | Straight | Sencilla | 直接投注/ | Pari Droit | | | |
| L-13 | Wager Type | Tipo de Apuesta | 投注类型 | Type de pari | | | |
| L-14 | Straight | Sencilla | 直接投注/ | Pari Droit | | | |
| L-15 | Parlay | Combinada | 连环过关/串 | Parlay | | | |
| L-16 | If Bets | Condicional | 如果-赢-或平赌注 | Si Parie | | | |
| L-17 | Action Reverse | Reversa | 来回过关 | Action Inverse | | | |
| L-18 | Refresh | Refrescar | 刷新 | Rafraîchir | | | |
| L-19 | Continue | Continuar | 继续 | Continue | | 계속 | |
| L-20 | Scores | Resultados | 分数 | Pointages | | 점수 | |
| L-21 | Error | Error | | | | 에러 | |
...
| L-45 | IfBet Bets(s) Accepted | Apuesta(s) aceptadas IfBet | | | | | |
...
| L-95 | Could not save the ticket | No se puedo guardar el boleto | | | | | |
| L-96 | Max | Maximo | | | | 최대 | |
| L-97 | Min | Minimo | | | | 최소 | |
...
### L-300 to L-399: Financial Operations
...
### L-800 to L-899: Help and Support
...
### L-1300 to L-1399: Management Tools
...
- Some language codes may have incomplete translations across all supported languages
- The system supports 7 languages with English and Spanish being the most complete
- Language codes are sequential and organized by functional categories

## Usage

These language codes are used throughout the system to provide localized text based on the user's language preference. Developers should reference these codes when implementing new features or modifying existing interfaces.
