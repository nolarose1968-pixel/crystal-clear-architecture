...
server.listen(PORT, () => {
    ...
    console.log('1. Open http://localhost:3000/test-service-worker.html in your browser');
    console.log('2. Register the service worker using the test interface');
    console.log('3. Test the token endpoint');
    console.log('4. To test offline behavior, use browser dev tools to go offline');
    console.log('5. Try accessing the token endpoint again - it should show the offline page');
});
